...
export const reqCaptchaImg = (params: CaptchaImgReq) =>
  http.get("/auth-api/auth/v1/captcha/" + params.uuid, params.params)
// 获取用户信息
...
export const reqRegisterUser = (params: AddUserReq) => http.post("/register/user", params)
