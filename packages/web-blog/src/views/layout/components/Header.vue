    ...
    <nav class="nav glass">
      <div class="nav-container">
        ...
        <div class="desktop-nav">
          <router-link v-for="item in menuItems" :key="item.path" class="nav-link" :to="item.path">
      ...
      <div class="search-box" :class="{ active: searchOpen }">
        <div class="search-input-wrapper">
          <input type="text" placeholder="搜索文章..." class="search-input" v-model="searchQuery" />
...
const menuItems = computed<MenuItem[]>(() => {
  ...
  return perm.navRoutes.map(r => ({
    ...
    label:
      (r.meta && (r.meta as { label?: string; title?: string }).label) ||
      (r.meta && (r.meta as { label?: string; title?: string }).title) ||
      undefined,
