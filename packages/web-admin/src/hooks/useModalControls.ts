...
type ModalActions<T, M extends Recordable> = BaseActions<T, M> & M
...
> {
  modalActions: ModalActions<T, M>
  modalProps: ModalProps
  refresh?: () => void
}

// 父组件使用
export const useModalControls = <T extends Recordable, M extends Recordable = Recordable>(): [
  ModalProps,
  ModalActions<T, M>,
] => {
