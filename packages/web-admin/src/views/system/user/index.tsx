...
const UserManage: React.FC = () => {
      ...
      render(value, record) {
        return (
          <Switch
            ...
            checked={value}
            onChange={check => updateUserStatus({ id: record.id, status: Number(check) })}
          />
        )
      },
    },
            ...
            <Button
              ...
              onClick={() => {
                modal.confirm({
                  ...
                  onOk: () => resetUserPassword({ id: record.id, password: "123456" }),
                })
              }}>
              重置密码
            </Button>
  ...
  return (
    <div className={styles.root}>
      ...
      />
      <ComImportData
        modalActions={importDataActions}
