...
export const reqAddModule = (params: AddModuleReq) =>
  http.post("/auth-api/v1/module/create", params);
export const reqDelModule = (params: CommonId) =>
  http.delete("/auth-api/v1/module/delete", params);
export const reqUpdateModule = (params: UpdateModuleReq) =>
  http.put("/auth-api/v1/module/update", params);
export const reqModuleList = () =>
  http.get<ModuleDataRes[]>("/auth-api/v1/module/list");
