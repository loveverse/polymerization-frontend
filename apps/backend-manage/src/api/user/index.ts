...
import { AddUserReq, UpdateUserReq, UpdateUserStatusReq, UserPageRes } from "./types";
/* 用户管理 */
export const reqUserPage = (params: PageReq) =>
  http.post<PageRes<UserPageRes>>("/embodied-user-api/manager/user/v1/page", params);
