...
/*
生成生产版本并将 d.ts 文件拼接在一起。要指定要构建的包，
只需将其名称和所需的构建格式传递给输出（默认为该包中指定的 'buildOptions.formats' 或 “esm，cjs”）：
'''
名称支持模糊匹配。将构建名称包含 “DOM” 的所有包： nr build dom 指定输出格式 nr build core --formats cjs
'''
*/
